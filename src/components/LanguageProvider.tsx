...
const translations = {
  en: {
    ...
    'occupancy.vs.utilization': 'Occupancy rate vs. utilization over the past year',
    'occupancy.by.department': 'Occupancy by Department',
    'avg.occupancy.departments': 'Average occupancy rate across different departments',
    'occupancy.by.seniority': 'Occupancy by Seniority',
    'occupancy.seniority.levels': 'Occupancy rates across different seniority levels',
  ...
  fr: {
    ...
    'occupancy.vs.utilization': 'Taux d\'occupation vs. utilisation au cours de l\'année passée',
    'occupancy.by.department': 'Occupation par Département',
    'avg.occupancy.departments': 'Taux d\'occupation moyen entre les différents départements',
    'occupancy.by.seniority': 'Occupation par Ancienneté',
    'occupancy.seniority.levels': 'Taux d\'occupation entre les différents niveaux d\'ancienneté',
    'current.vs.previous': 'Trimestre Actuel vs. Précédent',
    'comparison.quarters': 'Comparaison des tendances d\'occupation entre trimestres',
    ...
    'update.account.details': 'Mettre à jour les détails et préférences de votre compte',
    'appearance': 'Apparence',
    'customize.dashboard': 'Personnaliser l\'apparence du tableau de bord',
    'security.settings': 'Paramètres de Sécurité',
    'manage.password.security': 'Gérer votre mot de passe et la sécurité du compte',
    'data.management': 'Gestion des Données',
    'configure.data.storage': 'Configurer les politiques de stockage et de conservation des données',
