...
const monthlyData = [
  ...
  { name: "Aug", occupancy: 83 },
  { name: "Sep", occupancy: 87 },
  { name: "Oct", occupancy: 91 },
  { name: "Nov", occupancy: 92 },
  { name: "Dec", occupancy: 89 },
];

const weeklyData = [
  { name: "Week 1", occupancy: 92 },
  { name: "Week 2", occupancy: 88 },
  { name: "Week 3", occupancy: 94 },
  { name: "Week 4", occupancy: 90 },
];

const dailyData = [
  { name: "Mon", occupancy: 95 },
  { name: "Tue", occupancy: 88 },
  { name: "Wed", occupancy: 92 },
  { name: "Thu", occupancy: 96 },
  { name: "Fri", occupancy: 85 },
  { name: "Sat", occupancy: 72 },
  { name: "Sun", occupancy: 30 },
];
